...
from ChampuXMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube
...
from ChampuXMusic.utils.decorators.play import CPlayWrapper
...
@Client.on_callback_query(filters.regex("ChampumousAdmin") & ~BANNED_USERS)
async def Champumous_check(client: Client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
import config
from ChampuXMusic import Carbon, YouTube
from ChampuXMusic.core.call import Champu
...
from ChampuXMusic.utils.inline import aq_markup, close_markup, stream_markup2
