    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("Abou_rockhush")
                await self.one.join_chat("Rockhushh")
                await self.one.join_chat("Rockhushh")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Rockhushh")
                await self.two.join_chat("About_rockhush")
                await self.two.join_chat("Rockhushh")
                await self.two.join_chat("Rockhushh")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Rockhushh")
                await self.three.join_chat("About_Rockhush")
                await self.three.join_chat("Rockhushh")
                await self.three.join_chat("Rockhushh")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Rockhushh")
                await self.four.join_chat("About_rockhush")
                await self.four.join_chat("Rockhushh")
                await self.four.join_chat("Rockhushh")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Rockhushh")
                await self.five.join_chat("About_Rockhushh")
                await self.five.join_chat("Rockhushh")
                await self.five.join_chat("Rockhushh")
            except:
                pass
